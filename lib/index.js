...
class Cropper extends React.Component {
  ...
  componentDidMount () {
    ...
    this.listeners.addEventListener("mousemove", this.listeners.mousemove, false);
    this.listeners.addEventListener("mouseup", this.listeners.mouseup, false);
  ...
  componentWillUnmount () {
    var canvas = ReactDom.findDOMNode(this.refs.canvas);
    this.listeners.removeEventListener("mousemove", this.listeners.mousemove);
    this.listeners.removeEventListener("mouseup", this.listeners.mouseup);
